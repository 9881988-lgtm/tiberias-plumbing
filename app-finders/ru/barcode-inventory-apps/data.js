window.DIRECTORY_CONFIG = {
  "key": "app-finders:barcode-inventory-apps:ru",
  "title": "приложения штрихкод-инвентаря",
  ...
  "listings": [
    {
      ...
      "summary": "QR Code Reader，Barcode Scanner, разработчик AIR APPS SYSTEMS, UNIPESSOAL, LDA. В датированном снимке указаны категории Utilities, Business, версия 2026.3.4 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 96/100",
        "Бесплатно",
        "70,6 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.7/5 · 70,6 тыс.",
        "price": "Бесплатно",
    ...
    },
    {
      ...
      "summary": "QR Code Reader＊Barcode Scanner, разработчик VISARGERD, S.L.. В датированном снимке указаны категории Utilities, Reference, версия 4.8.2 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 91/100",
        "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Barcode Scanner - Orca Scan, разработчик ORCA SCAN LIMITED. В датированном снимке указаны категории Productivity, Business, версия 12.7.2 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Inventory with barcode, разработчик emmanuel orvain. В датированном снимке указаны категории Productivity, Utilities, версия 7.29.3 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Inventory Easy - Stock Tracker, разработчик B TO J PTY LTD. В датированном снимке указаны категории Business, Productivity, версия 27.1 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "BoxHero: Inventory Management, разработчик BGPworks. В датированном снимке указаны категории Business, Productivity, версия 3.57.0 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Stockroom Inventory, разработчик Stockroom Software LLC. В датированном снимке указаны категории Productivity, Business, версия 3.6.6 и обновление 2025 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "BoxOrganizer - Inventory, разработчик BO24 UG (haftungsbeschraenkt). В датированном снимке указаны категории Productivity, Lifestyle, версия 2.2.2 и обновление 2025 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 69/100",
        "Бесплатно",
        "146 число оценок"
      ],
      "facts": {
    ...
    },
    {
      ...
      "summary": "Inventory Scan, разработчик Cesar Augusto Trujillo Cetina. В датированном снимке указаны категории Productivity, Utilities, версия 3.0.5 и обновление 2023 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Donate2Support, разработчик Special Moments Of Arkansas LLC. В датированном снимке указаны категории Social Networking, версия 1.5.13 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 54/100",
        "Бесплатно",
        "109 число оценок"
      ],
      "facts": {
    ...
    },
    {
      ...
      "summary": "Physical Inventory Barcode, разработчик CITEK TECHNOLOGY JOINT STOCK COMPANY. В датированном снимке указаны категории Productivity, версия 1.2 и обновление 2021 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
