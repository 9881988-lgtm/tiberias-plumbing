window.DIRECTORY_CONFIG = {
  "key": "app-finders:whiteboard-scanner-apps:ru",
  "title": "сканеры досок",
  ...
  "listings": [
    {
      ...
      "summary": "TurboScan™: document scanner, разработчик Piksoft Inc.. В датированном снимке указаны категории Business, Productivity, версия 3.4.1 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 99/100",
        "Бесплатно",
        "101,3 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.9/5 · 101,3 тыс.",
        "price": "Бесплатно",
    ...
    },
    {
      ...
      "summary": "TurboScan™ Pro: PDF scanner, разработчик Piksoft Inc.. В датированном снимке указаны категории Business, Productivity, версия 3.4.1 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 99/100",
        "Платно",
        "295,6 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.9/5 · 295,6 тыс.",
        "price": "$9.99",
        "system": "iOS/iPadOS 13.0+"
      },
      "filters": {
    ...
    },
    {
      ...
      "summary": "xScan : Document Scanner App, разработчик VPN MobApps Limited. В датированном снимке указаны категории Business, Productivity, версия 2.10.5 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 93/100",
        "Бесплатно",
        "31,1 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.6/5 · 31,1 тыс.",
        "price": "Бесплатно",
    ...
    },
    {
      ...
      "summary": "JotNot Scanner App Pro, разработчик MobiTech 3000 LLC. В датированном снимке указаны категории Business, Productivity, версия 5.1.4 и обновление 2020 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 80/100",
        "Платно",
        "30,2 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.9/5 · 30,2 тыс.",
        "price": "$6.99",
    ...
    },
    {
      ...
      "summary": "JotNot Scanner App, разработчик MobiTech 3000 LLC. В датированном снимке указаны категории Productivity, Business, версия 5.1.4 и обновление 2020 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "SlatCam: Whiteboard Scanner, разработчик JASON JEONG. В датированном снимке указаны категории Productivity, Photo & Video, версия 1.0.1 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Scanner: Scan Documents, разработчик Distrito SLU. В датированном снимке указаны категории Business, версия 1.5 и обновление 2020 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 75/100",
        "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Whiteboard Lens, разработчик Henrik Lexow. В датированном снимке указаны категории Productivity, Business, версия 1.1.1 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "MEMO Whiteboard Scanner, разработчик New Things Lab B.V.. В датированном снимке указаны категории Productivity, версия 1.0.4 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 74/100",
        "Бесплатно",
        "1 число оценок"
    ...
    },
    {
      ...
      "summary": "CaptureBoard: Scan Whiteboard, Business cards, receipts and more, разработчик MaaDoTaa LLC. В датированном снимке указаны категории Utilities, Photo & Video, версия 3.5 и обновление 2016 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 21/100",
        "Бесплатно",
        "6 число оценок"
      ],
      "facts": {
