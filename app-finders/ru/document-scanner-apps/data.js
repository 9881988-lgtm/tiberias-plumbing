window.DIRECTORY_CONFIG = {
  "key": "app-finders:document-scanner-apps:ru",
  "title": "приложения-сканеры документов",
  ...
  "listings": [
    ...
    },
    {
      ...
      "summary": "Scanner App. JPG, Photo to PDF, разработчик Municorn Limited. В датированном снимке указаны категории Business, Productivity, версия 2.7.5 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 97/100",
        "Бесплатно",
        "74,2 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.8/5 · 74,2 тыс.",
        "price": "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Document Scanner by Lufick, разработчик Lufick. В датированном снимке указаны категории Productivity, Business, версия 3.5.4 и обновление 2025 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "ScaniX PDF Document Scanner, разработчик SWIFTY BRAINS LLP. В датированном снимке указаны категории Business, Utilities, версия 1.2 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 77/100",
        "Бесплатно",
        "49 число оценок"
