window.DIRECTORY_CONFIG = {
  "key": "app-finders:mac-uninstaller-apps:ru",
  "title": "деинсталляторы для Mac",
  ...
  "listings": [
    {
      ...
      "summary": "Delete Apps: Uninstaller, разработчик FIPLAB Ltd. В датированном снимке указаны категории Utilities, Business, версия 2.4 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Uninstaller - Clean App File‪s, разработчик 凌云 张. В датированном снимке указаны категории Utilities, Productivity, версия 2.7.3 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 20/100",
        "Бесплатно",
        "Ниже 4,0 / нет рейтинга"
    ...
    },
    {
      ...
      "summary": "XApp - Uninstall Expert, разработчик Ningbo Shangguan Technology Co.,Ltd.. В датированном снимке указаны категории Utilities, версия 1.1.9 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 20/100",
        "Бесплатно",
        "Ниже 4,0 / нет рейтинга"
    ...
    },
    {
      ...
      "summary": "CleanApp: Deep Uninstaller, разработчик Hangzhou Yuuan Technology Co., Ltd. В датированном снимке указаны категории Utilities, Productivity, версия 2.1.0 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 20/100",
        "Бесплатно",
        "Ниже 4,0 / нет рейтинга"
    ...
    },
    {
      ...
      "summary": "Uninstaller sensei, разработчик Maksym Katrych. В датированном снимке указаны категории Utilities, Productivity, версия 1.9.1 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 20/100",
        "Бесплатно",
        "Ниже 4,0 / нет рейтинга"
    ...
    },
    {
      ...
      "summary": "App Cleaner - App Uninstaller, разработчик 裕涛 兰. В датированном снимке указаны категории Utilities, версия 1.0.5 и обновление 2025 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 16/100",
        "Бесплатно",
        "Ниже 4,0 / нет рейтинга"
    ...
    },
    {
      ...
      "summary": "Uninstaller-OS Cleaner, разработчик 坤 刘. В датированном снимке указаны категории Productivity, Utilities, версия 12.5.9 и обновление 2025 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 16/100",
        "Платно",
        "Ниже 4,0 / нет рейтинга"
    ...
    },
    {
      ...
      "summary": "CleanMyApp - Uninstaller, разработчик 军诗 程. В датированном снимке указаны категории Utilities, Lifestyle, версия 2.0 и обновление 2025 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Uninstaller - Clean Your App, разработчик 光蓉 蔡. В датированном снимке указаны категории Utilities, версия 1.0.1 и обновление 2025 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 10/100",
        "Бесплатно",
        "Ниже 4,0 / нет рейтинга"
    ...
    },
    {
      ...
      "summary": "App Uninstaller - Clean Leftover Application Files, разработчик Pocket Bits LLC. В датированном снимке указаны категории Utilities, Productivity, версия 1.0 и обновление 2017 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "CareOS - App Uninstaller, разработчик 永康 李. В датированном снимке указаны категории Productivity, Utilities, версия 6.5.79 и обновление 2023 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 4/100",
        "Бесплатно",
        "Ниже 4,0 / нет рейтинга"
