window.DIRECTORY_CONFIG = {
  "key": "app-finders:social-media-scheduler-apps:ru",
  "title": "планировщики соцсетей",
  ...
  "listings": [
    ...
    },
    {
      ...
      "summary": "Buffer: Plan & Schedule Posts, разработчик Buffer, Inc.. В датированном снимке указаны категории Social Networking, Business, версия 15.7.2 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 95/100",
        "Бесплатно",
        "34,1 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.7/5 · 34,1 тыс.",
        "price": "Бесплатно",
    ...
    },
    {
      ...
      "summary": "PREVIEW: Planner for Instagram, разработчик Preview App Pty Ltd. В датированном снимке указаны категории Photo & Video, Graphics & Design, версия 4.1.0 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 95/100",
        "Бесплатно",
        "44,6 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.7/5 · 44,6 тыс.",
        "price": "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Planoly: Social Media Planner, разработчик Planogram, Inc. В датированном снимке указаны категории Photo & Video, Productivity, версия 6.0.5 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 94/100",
        "Бесплатно",
        "26,9 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.7/5 · 26,9 тыс.",
        "price": "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Hootsuite - Social Media Tools, разработчик Hootsuite Inc.. В датированном снимке указаны категории Social Networking, Business, версия 11.6.2 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 94/100",
        "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Publer: Social Media Tools, разработчик Kalemi LLC. В датированном снимке указаны категории Social Networking, Productivity, версия 2.5.1 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 94/100",
        "Бесплатно",
        "23,1 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.8/5 · 23,1 тыс.",
        "price": "Бесплатно",
        "system": "iOS/iPadOS 15.1+"
      },
      "filters": {
    ...
    },
    {
      ...
      "summary": "Apphi: Social Media Scheduler, разработчик Apphi, Inc.. В датированном снимке указаны категории Social Networking, Productivity, версия 11.10.0 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 87/100",
        "Бесплатно",
        "3,5 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.6/5 · 3,5 тыс.",
        "price": "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Later: Social Media Scheduler, разработчик Victory Square Media Inc.. В датированном снимке указаны категории Photo & Video, Productivity, версия 10.5 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Planable: social media planner, разработчик Planable Inc.. В датированном снимке указаны категории Social Networking, Productivity, версия 1.55.4 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "SocialClaw : Post & Schedule, разработчик Nardi Braho. В датированном снимке указаны категории Social Networking, Productivity, версия 1.0 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Planly: Social Media Scheduler, разработчик dlivrd LLC. В датированном снимке указаны категории Social Networking, Business, версия 1.3.2 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 20/100",
        "Бесплатно",
        "Ниже 4,0 / нет рейтинга"
    ...
    },
    {
      ...
      "summary": "Postdeck: Social Media Planner, разработчик Joseph Morton. В датированном снимке указаны категории Utilities, Social Networking, версия 1.2 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 20/100",
        "Бесплатно",
        "Ниже 4,0 / нет рейтинга"
