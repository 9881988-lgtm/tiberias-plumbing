window.DIRECTORY_CONFIG = {
  "key": "app-finders:voice-recorder-apps:ru",
  "title": "диктофоны",
  ...
  "listings": [
    {
      ...
      "summary": "Voice Recorder Lite: Record HD, разработчик LiveBird Technologies Private Limited. В датированном снимке указаны категории Business, Productivity, версия 9.1 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 95/100",
        "Бесплатно",
        "73,5 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.6/5 · 73,5 тыс.",
        "price": "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Voice Memos, разработчик Apple Inc.. В датированном снимке указаны категории Utilities, версия 2.6 и обновление 2025 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Voice recorder - Voz, разработчик Hieu Nguyen. В датированном снимке указаны категории Utilities, Productivity, версия 3.4 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 93/100",
        "Бесплатно",
        "25,5 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.6/5 · 25,5 тыс.",
        "price": "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Voice Record Pro, разработчик Dayana Networks Ltd. В датированном снимке указаны категории Utilities, Music, версия 4.1.3 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 93/100",
        "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Easy Voice Recorder, разработчик Digipom Inc.. В датированном снимке указаны категории Productivity, Utilities, версия 1.3.2 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Voice Recorder & Notes Pro, разработчик Linfei Ltd.. В датированном снимке указаны категории Utilities, Productivity, версия 13.4 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 91/100",
        "Бесплатно",
        "13,2 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.6/5 · 13,2 тыс.",
        "price": "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Voice Recorder & Transcribe, разработчик Jakub Bartus. В датированном снимке указаны категории Business, Utilities, версия 15.0.1 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Voice recorder: Audio editor, разработчик Hieu Nguyen. В датированном снимке указаны категории Utilities, Productivity, версия 4.17 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 89/100",
        "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Voice Recorder & Audio Editor, разработчик TapMedia Ltd. В датированном снимке указаны категории Utilities, Business, версия 6.0.8 и обновление 2025 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 87/100",
        "Бесплатно",
        "451,5 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.7/5 · 451,5 тыс.",
        "price": "Бесплатно",
        "system": "iOS/iPadOS 16.0+"
      },
      "filters": {
    ...
    },
    {
      ...
      "summary": "Voice Recorder — Audio Memos, разработчик PrimeForm OU. В датированном снимке указаны категории Business, Utilities, версия 3.3.13 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "75 Days Challenge - Reset75, разработчик EHM TECH LLC. В датированном снимке указаны категории Health & Fitness, Lifestyle, версия 1.0.6 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "De Jure AI, разработчик Detech Yazilim Anonim Sirketi. В датированном снимке указаны категории Reference, версия 2.6.1 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 32/100",
        "Бесплатно",
        "1 число оценок"
      ],
      "facts": {
