window.DIRECTORY_CONFIG = {
  "key": "app-finders:train-planner-apps:ru",
  "title": "планировщики поездок на поезде",
  ...
  "listings": [
    {
      ...
      "summary": "Citymapper: All Live Transit, разработчик Citymapper Limited. В датированном снимке указаны категории Navigation, Travel, версия 11.47 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 99/100",
        "Бесплатно",
        "106,3 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.9/5 · 106,3 тыс.",
        "price": "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Eurostar: Train travel & Hotel, разработчик Eurostar International Limited. В датированном снимке указаны категории Travel, версия 15.0.1271 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 95/100",
        "Бесплатно",
        "25,9 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.9/5 · 25,9 тыс.",
        "price": "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Trainline: Cheap Train Tickets, разработчик thetrainline. В датированном снимке указаны категории Travel, Navigation, версия 429.0.0 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 93/100",
        "Бесплатно",
        "9,8 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.9/5 · 9,8 тыс.",
        "price": "Бесплатно",
        "system": "iOS/iPadOS 17.0+"
      },
      "filters": {
    ...
    },
    {
      ...
      "summary": "Train Ticket App : RailYatri, разработчик Stelling Technologies Private Limited. В датированном снимке указаны категории Travel, Utilities, версия 4.17 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 89/100",
        "Бесплатно",
        "6,4 тыс. число оценок"
      ],
      "facts": {
        "rating": "4.6/5 · 6,4 тыс.",
        "price": "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Rome2Rio: Travel Route Planner, разработчик Rome2rio Pty Ltd. В датированном снимке указаны категории Travel, Navigation, версия 2026.08.10 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "TrainPal: UK& EU train tickets, разработчик Trainpal B.V.. В датированном снимке указаны категории Travel, Navigation, версия 3.89.0 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Mapway: Maps & Transit Planner, разработчик Mapway Inc.. В датированном снимке указаны категории Navigation, Travel, версия 2.10.0 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 83/100",
        "Бесплатно",
    ...
    },
    {
      ...
      "summary": "Seatfrog: Rail Journey Planner, разработчик Seatfrog PTY LTD. В датированном снимке указаны категории Travel, Lifestyle, версия 4.4.18 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
        "Доказательства 83/100",
        "Бесплатно",
        "352 число оценок"
    ...
    },
    {
      ...
      "summary": "National Rail, разработчик Train Information Services Limited. В датированном снимке указаны категории Travel, Navigation, версия 10.4.0 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Train Times UK Journey Planner, разработчик APP KTCHN LTD. В датированном снимке указаны категории Travel, Business, версия 5.1.12 и обновление 2024 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Eurail/Interrail Rail Planner, разработчик Interrail B.V.. В датированном снимке указаны категории Travel, Navigation, версия 53.1.0 и обновление 2026 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
    ...
    },
    {
      ...
      "summary": "Train Journey Planner - UK, разработчик Sumit Kukadiya. В датированном снимке указаны категории Travel, версия 1.0 и обновление 2024 года. Функции, приватность и покупки проверяйте в текущей карточке Apple.",
      "tags": [
