...
Готовый статический сайт для рекламы установки солнечных бойлеров, подключения стиральных и посудомоечных машин, водопровода и сантехнических работ в Тверии, Израиль.
...
- `script.js` — кнопка копирования телефона.
