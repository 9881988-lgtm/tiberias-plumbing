# SEO лендинг: мойка внутреннего блока кондиционера в Тверии

Полноценный SEO-лендинг с backend-формой для услуги `מים ושמש - ניקוי מזגנים`: мойка внутреннего блока кондиционера, чистка фильтров и дезинфекция в Тверии и окрестностях. Основной язык — иврит, русский включается кнопкой.

## Что сделано

- SEO meta-теги, Open Graph, Twitter card, canonical и sitemap.
- JSON-LD schema.org для `HVACBusiness`, `WebSite`, `WebPage` и `FAQPage`.
- Контакты взяты из проекта по сантехнике: `053 361 3100`.
- График взят оттуда же: воскресенье-четверг, `09:00-18:00`.
- Цена услуги: `450-500 ₪` за внутренний блок с дезинфекцией.
...
- мойка кондиционера Тверия
- чистка внутреннего блока кондиционера Тверия
- AC cleaning Tiberias
