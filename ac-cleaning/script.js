...
const translations = {
  he: {
    ...
    description: "ניקוי מזגנים בטבריה: ניקוי בסיסי מ-250 ₪, ניקוי עמוק + חיטוי מ-450 ₪, יחידה שנייה מ-200 ₪. שלחו תמונה ב-WhatsApp.",
    brandTitle: "מים ושמש",
  ...
  ru: {
    ...
    description: "Мойка кондиционеров в Тверии: базовая чистка 250 ₪, глубокая + дезинфекция от 450 ₪, второй блок от 200 ₪. Отправьте фото в WhatsApp.",
  ...
  en: {
    ...
    description: "AC cleaning in Tiberias: basic cleaning 250 ₪, deep cleaning + disinfection from 450 ₪, second unit from 200 ₪. Send a photo on WhatsApp.",
  ...
  fr: {
    ...
    description: "Nettoyage de climatiseurs à Tibériade : nettoyage de base 250 ₪, nettoyage profond + désinfection dès 450 ₪, deuxième unité dès 200 ₪. Photo par WhatsApp.",
    brandTitle: "Mayim VeShemesh",
...
const whatsappMessages = {
  he: "שלום, ראיתי את הפרסום לניקוי מזגנים בטבריה. אני רוצה לבדוק זמינות להיום/מחר. ניקוי בסיסי 250 ₪, ניקוי עמוק + חיטוי מ-450 ₪, יחידה שנייה מ-200 ₪.",
  ru: "Здравствуйте, увидел рекламу мойки кондиционеров в Тверии. Хочу проверить доступность на сегодня/завтра. Базовая чистка 250 ₪, глубокая + дезинфекция от 450 ₪, второй блок от 200 ₪.",
  en: "Hello, I saw the AC cleaning ad in Tiberias. I would like to check availability for today/tomorrow. Basic cleaning 250 ₪, deep cleaning + disinfection from 450 ₪, second unit from 200 ₪.",
  fr: "Bonjour, j'ai vu la publicité pour le nettoyage de climatiseurs à Tibériade. Je voudrais vérifier la disponibilité pour aujourd'hui/demain. Nettoyage de base 250 ₪, nettoyage profond + désinfection dès 450 ₪, deuxième unité dès 200 ₪."
};
