...
const translations = {
  he: {
    title: "ניקוי מזגנים בטבריה | שטיפת יחידה פנימית וחיטוי | 053 361 3100",
    description: "ניקוי מזגנים בטבריה: ניקוי אקספרס + חיטוי ב-190 ₪ או 3 מזגנים ב-490 ₪. שלחו תמונה ב-WhatsApp.",
    brandTitle: "מים ושמש",
    ...
    heroEyebrow: "טבריה, ישראל · WhatsApp מהיר",
    heroTitle: "ניקוי מזגנים בטבריה",
    heroLead: "יש ריח רע מהמזגן, אבק או קירור חלש? מבצע בטבריה: ניקוי אקספרס עם חיטוי ב-190 ₪, או 3 מזגנים באותה כתובת ב-490 ₪. שלחו תמונה ב-WhatsApp ונבדוק התאמה וזמינות היום.",
    ...
    whyTitle: "שירות מקומי בטבריה עם מענה מהיר ב-WhatsApp",
    ...
    areaTitle: "ניקוי מזגנים בטבריה, ישראל",
    areaText: "השירות מתאים למזגנים עיליים בדירות, יחידות אירוח, קליניקות ועסקים קטנים בטבריה. שולחים כתובת ותמונה ב-WhatsApp ומקבלים הערכת מחיר לפני הגעה.",
    ...
    footerText: "ניקוי יחידה פנימית, שטיפה וחיטוי בטבריה, ישראל."
  },
  ru: {
    title: "Мойка кондиционеров в Тверии | Чистка внутреннего блока | 053 361 3100",
    description: "Мойка кондиционеров в Тверии: экспресс-мойка с дезинфекцией 190 ₪ или 3 кондиционера за 490 ₪. Отправьте фото в WhatsApp.",
    ...
    heroEyebrow: "Тверия, Израиль · быстрый WhatsApp",
    heroTitle: "Мойка кондиционеров в Тверии",
    heroLead: "Есть запах, пыль или слабое охлаждение? Акция в Тверии: экспресс-мойка с дезинфекцией за 190 ₪ или 3 кондиционера по одному адресу за 490 ₪. Пришлите фото в WhatsApp, проверим условия и доступность сегодня.",
    ...
    whyTitle: "Местный сервис в Тверии с быстрым ответом в WhatsApp",
    ...
    areaTitle: "Мойка кондиционеров в Тверии, Израиль",
    areaText: "Услуга подходит для настенных кондиционеров в квартирах, гостевых домах, кабинетах и небольших бизнесах Тверии. Отправьте адрес и фото в WhatsApp, чтобы получить оценку до выезда.",
    ...
    footerText: "Чистка внутреннего блока, промывка и дезинфекция в Тверии, Израиль."
  },
  en: {
    title: "AC Cleaning in Tiberias | Indoor Unit Washing | 053 361 3100",
    description: "AC cleaning in Tiberias: express cleaning with disinfection for 190 ₪ or 3 AC units for 490 ₪. Send a photo on WhatsApp.",
    ...
    navFaq: "Questions",
    languageButton: "עברית",
    heroEyebrow: "Tiberias, Israel · fast WhatsApp",
    heroTitle: "AC cleaning in Tiberias",
    heroLead: "Bad smell, dust or weak cooling? Tiberias offer: express AC cleaning with disinfection for 190 ₪, or 3 AC units at the same address for 490 ₪. Send a photo on WhatsApp and we will confirm eligibility and availability today.",
    ...
    whyTitle: "Local service in Tiberias with fast WhatsApp response",
    ...
    areaTitle: "AC cleaning in Tiberias, Israel",
    areaText: "The service is suitable for wall-mounted AC units in apartments, guest units, offices and small businesses in Tiberias. Send your address and a photo on WhatsApp for an estimate before the visit.",
    ...
    footerText: "Indoor unit cleaning, washing and disinfection in Tiberias, Israel."
  },
  fr: {
    title: "Nettoyage de climatiseurs à Tibériade | Unité intérieure | 053 361 3100",
    description: "Nettoyage de climatiseurs à Tibériade : nettoyage express avec désinfection à 190 ₪ ou 3 climatiseurs pour 490 ₪. Photo par WhatsApp.",
    brandTitle: "Mayim VeShemesh",
    ...
    navFaq: "Questions",
    languageButton: "עברית",
    heroEyebrow: "Tibériade, Israël · WhatsApp rapide",
    heroTitle: "Nettoyage de climatiseurs à Tibériade",
    heroLead: "Mauvaise odeur, poussière ou refroidissement faible ? Offre à Tibériade : nettoyage express avec désinfection à 190 ₪, ou 3 climatiseurs à la même adresse pour 490 ₪. Envoyez une photo sur WhatsApp pour confirmer l'offre et la disponibilité.",
    ...
    whyTitle: "Service local à Tibériade avec réponse rapide sur WhatsApp",
    ...
    areaTitle: "Nettoyage de climatiseurs à Tibériade, Israël",
    areaText: "Le service convient aux climatiseurs muraux dans les appartements, logements d'hôtes, bureaux et petits commerces à Tibériade. Envoyez l'adresse et une photo sur WhatsApp pour une estimation avant la visite.",
    contactTitle: "Contact",
    ...
    footerText: "Nettoyage, lavage et désinfection de l'unité intérieure à Tibériade, Israël."
  }
};

const whatsappMessages = {
  he: "שלום, ראיתי את המבצע לניקוי מזגנים בטבריה. אני רוצה לבדוק זמינות לניקוי אקספרס + חיטוי ב-190 ₪ / 3 מזגנים ב-490 ₪. אפשר לשלוח תמונה?",
  ru: "Здравствуйте, увидел акцию на мойку кондиционеров в Тверии. Хочу проверить доступность: экспресс-мойка + дезинфекция 190 ₪ / 3 кондиционера за 490 ₪. Можно отправить фото?",
  en: "Hello, I saw the AC cleaning offer in Tiberias. I would like to check availability: express cleaning + disinfection 190 ₪ / 3 AC units for 490 ₪. Can I send a photo?",
  fr: "Bonjour, j'ai vu l'offre de nettoyage de climatiseurs à Tibériade. Je voudrais vérifier la disponibilité : nettoyage express + désinfection 190 ₪ / 3 climatiseurs pour 490 ₪. Puis-je envoyer une photo ?"
};
...
const emailSubjects = {
  he: "בקשה לניקוי מזגן בטבריה",
  ru: "Заявка на мойку кондиционера в Тверии",
  en: "AC cleaning request in Tiberias",
  fr: "Demande de nettoyage de climatiseur à Tibériade"
};
