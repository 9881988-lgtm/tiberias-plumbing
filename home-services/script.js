(function () {
  ...
  const translations = {
    he: {
      brandTitle: "מים ושמש",
      brandSubtitle: "שירותי בית בטבריה, קיסריה וחריש",
      navServices: "שירותים",
      navLead: "הזמנה",
      navFaq: "שאלות",
      languageButton: "Русский",
      heroEyebrow: "טבריה · קיסריה · חריש +20 ק״מ · מענה מהיר ב-WhatsApp",
      heroTitle: "דודי שמש, ניקוי מזגנים ועבודות קטנות",
      heroLead: "דוד שמש קומפלט מ-₪3,450, ניקוי מזגן מ-₪190, מבצע 3 מזגנים ב-₪500 ועבודות קטנות בבית באזור טבריה, קיסריה, חריש והיישובים הקרובים. מענה בעברית וברוסית.",
      bookButton: "לקבלת הצעת מחיר",
      badgeArea: "טבריה, קיסריה וחריש",
      ...
      leadText: "אפשר גם ללחוץ WhatsApp ולשלוח לנו ישירות: איזה שירות צריך, כתובת בטבריה, קיסריה, חריש או בסביבה, ותמונה אם היא עוזרת להבין את העבודה.",
      check1: "שירות בטבריה, קיסריה, חריש והיישובים הקרובים ברדיוס כ-20 ק״מ",
      ...
      faq1A: "טבריה והסביבה, קיסריה, חריש והיישובים הקרובים עד כ-20 ק״מ, כולל אור עקיבא, בנימינה, גבעת עדה, פרדס חנה-כרכור, זכרון יעקב, חדרה, קציר, מענית, באקה אל-גרבייה, כפר קרע, ערערה ואום אל-פחם, לפי זמינות וסוג העבודה.",
    ...
    ru: {
      ...
      brandSubtitle: "Услуги на дому в Тверии, Кейсарии и Харише",
      navServices: "Услуги",
      navLead: "Заявка",
      navFaq: "Вопросы",
      languageButton: "עברית",
      heroEyebrow: "Тверия · Кейсария · Хариш +20 км · быстрый ответ в WhatsApp",
      heroTitle: "Солнечные бойлеры, мойка кондиционеров и мелкий ремонт",
      heroLead: "Солнечный бойлер с установкой от ₪3,450, мойка кондиционера от ₪190, акция 3 за ₪500 и мелкие работы дома в районе Тверии, Кейсарии, Хариша и рядом.",
      bookButton: "Получить цену",
      badgeArea: "Тверия, Кейсария, Хариш",
      ...
      leadText: "Можно нажать WhatsApp и сразу написать: какая услуга нужна, адрес в Тверии, Кейсарии, Харише или рядом, и приложить фото, если оно поможет оценить работу.",
      check1: "Выезд в Тверии, Кейсарии, Харише и ближайших городах до 20 км",
      ...
      faq1A: "Тверия и рядом, Кейсария, Хариш и ближайшие населенные пункты до 20 км: Ор-Акива, Биньямина, Гиват-Ада, Пардес-Хана-Каркур, Зихрон-Яаков, Хадера, Кацир, Маанит, Бака-эль-Гарбия, Кафр-Кара, Арара и Умм-эль-Фахм, в зависимости от доступности и вида работы.",
  ...
  const whatsappMessage = () => {
    if (currentLanguage === "ru") {
      return [
        "Здравствуйте! Хочу получить цену на услугу в районе Тверии, Кейсарии или Хариша.",
    ...
    return [
      "שלום, אשמח לקבל הצעת מחיר לשירות באזור טבריה, קיסריה או חריש.",
      `טלפון: ${displayPhone}`,
