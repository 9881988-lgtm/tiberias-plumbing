(function () {
  ...
  const translations = {
    ...
    ru: {
      ...
      heroLead: "Солнечный бойлер под ключ от ₪3,450, мойка кондиционера от ₪190, акция 3 за ₪500 и мелкие работы дома в районе Тверии.",
      ...
      faq3A: "Цена зависит от вида работы, доступа, материалов и количества единиц. Солнечный бойлер под ключ от ₪3,450; мойка кондиционера от ₪190, акция 3 за ₪500."
    }
  };
