...
const translations = {
  he: {
    title: "דודי שמש בטבריה | מכירה והתקנה מ-3500 ₪ | 053 361 3100",
    description: "מכירה והתקנה של דודי שמש בטבריה והסביבה: דוד שמש, קולטים, חיבורי מים ובדיקת מערכת. מחיר החל מ-3500 ₪, תיאום מהיר ב-WhatsApp או במייל.",
    brandTitle: "מים ושמש",
    ...
    heroEyebrow: "טבריה והסביבה · מכירה והתקנה",
    heroTitle: "דוד שמש חדש לבית, כולל התקנה מסודרת",
    heroLead: "אספקה והתקנה של דודי שמש וקולטים, חיבורי מים ובדיקת מערכת. מתאים לדירות, בתים פרטיים ויחידות אירוח באזור טבריה וסובב כנרת.",
    bookButton: "לקבלת הצעת מחיר",
    bookButtonShort: "להצעת מחיר",
    priceNote: "החל מ-3500 ₪ לדוד שמש",
    ...
    leadText: "מחיר דוד שמש מתחיל מ-3500 ₪. אחרי שליחת הפרטים נפתחת הודעת WhatsApp מוכנה, הבקשה מגיעה למאסטר ונשמר חלון עבודה ביומן להמשך תיאום.",
    ...
    submitWorking: "שולח...",
    successWithGoogle: "הבקשה נשלחה והמועד נשלח לשמירה ביומן. מחיר התחלתי מאושר: החל מ-3500 ₪ לדוד שמש.",
    successFallback: "הפרטים מוכנים לשליחה. מחיר התחלתי מאושר: החל מ-3500 ₪ לדוד שמש.",
    ...
    areaTitle: "דודי שמש בטבריה, סביב הכנרת והיישובים הקרובים",
    areaText: "העבודה מתאימה לבתים פרטיים, דירות, יחידות אירוח ועסקים קטנים. יציאה מחוץ לטבריה מתואמת לפי מרחק, גישה לגג וזמינות.",
    ...
    faq3Answer: "המחיר מתחיל מ-3500 ₪ לדוד שמש. המחיר הסופי תלוי בנפח, קולטים, גישה לגג ומצב חיבורי המים.",
    ...
    footerText: "מכירה והתקנה של דודי שמש באזור טבריה."
  },
  ru: {
    title: "Солнечные бойлеры в Тверии | Продажа и установка от 3500 ₪ | 053 361 3100",
    description: "Продажа и установка солнечных бойлеров в Тверии и окрестностях: бойлер, коллекторы, водяные подключения и проверка системы. Цена от 3500 ₪, заявка через WhatsApp или email.",
    ...
    heroEyebrow: "Тверия и окрестности · продажа и установка",
    heroTitle: "Новый солнечный бойлер для дома с аккуратной установкой",
    heroLead: "Поставка и установка солнечных бойлеров и коллекторов, подключение воды и проверка системы. Для квартир, частных домов и гостевых юнитов в районе Тверии и Кинерета.",
    bookButton: "Получить цену",
    bookButtonShort: "Цена",
    priceNote: "от 3500 ₪ за солнечный бойлер",
    ...
    leadText: "Цена солнечного бойлера начинается от 3500 ₪. После отправки откроется готовое сообщение WhatsApp, заявка придет мастеру и рабочий слот будет зарезервирован для дальнейшего согласования.",
    ...
    successWithGoogle: "Заявка отправлена, выбранный слот передан на бронирование в календарь. Стартовая цена подтверждена: от 3500 ₪ за солнечный бойлер.",
    successFallback: "Данные готовы к отправке. Стартовая цена подтверждена: от 3500 ₪ за солнечный бойлер.",
    ...
    areaTitle: "Солнечные бойлеры в Тверии, вокруг Кинерета и рядом",
    areaText: "Работа подходит для частных домов, квартир, гостевых юнитов и небольших бизнесов. Выезд за пределы Тверии согласуется по расстоянию, доступу на крышу и доступности.",
    ...
    faq3Answer: "Цена начинается от 3500 ₪ за солнечный бойлер. Финальная цена зависит от объема, коллекторов, доступа на крышу и состояния водяных подключений.",
    ...
    footerText: "Продажа и установка солнечных бойлеров в районе Тверии."
  }
};

const whatsappMessages = {
  he: "שלום, אני רוצה לקבל הצעת מחיר לדוד שמש בטבריה והסביבה. המחיר מתחיל מ-3500 ₪.",
  ru: "Здравствуйте, хочу получить цену на солнечный бойлер в Тверии и окрестностях. Цена начинается от 3500 ₪."
};
...
const applyLanguage = (language) => {
  ...
  setMeta('meta[property="og:title"]', isHebrew ? "דודי שמש בטבריה | מכירה והתקנה מ-3500 ₪" : "Солнечные бойлеры в Тверии | Продажа и установка от 3500 ₪");
  setMeta('meta[property="og:description"]', isHebrew ? "מכירה, התקנה וחיבור דודי שמש בטבריה והסביבה. מחיר החל מ-3500 ₪." : "Продажа и установка солнечных бойлеров в Тверии и окрестностях. Цена от 3500 ₪.");
  setMeta('meta[property="og:locale"]', isHebrew ? "he_IL" : "ru_RU");
  setMeta('meta[name="twitter:title"]', isHebrew ? "דודי שמש בטבריה | מכירה והתקנה מ-3500 ₪" : "Солнечные бойлеры в Тверии | Продажа и установка от 3500 ₪");
  setMeta('meta[name="twitter:description"]', isHebrew ? "מכירה והתקנה של דודי שמש בטבריה והסביבה. מחיר החל מ-3500 ₪." : "Продажа и установка солнечных бойлеров в Тверии и окрестностях. Цена от 3500 ₪.");
